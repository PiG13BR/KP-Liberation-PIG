...
KPLIB_b_vehAir = [
    ...
    ["B_Heli_Attack_01_pylons_dynamicLoadout_F",500,800,200],           // RAH-66 Comanche
    ["B_Heli_Transport_01_unarmed_F",250,0,150],                        // UH-80 Ghost Hawk (Unarmed)
    ["B_Heli_Transport_01_F",250,80,150],                               // UH-80 Ghost Hawk
    ["B_Heli_Transport_01_camo_F",250,80,150],                          // UH-80 Ghost Hawk (Camo)
    ["B_Heli_Transport_01_pylons_F",250,400,150],                       // UH-80 Ghost Hawk (Stub Wings)
    ["B_CTRG_Heli_Transport_01_Assault_F",350,80,150],                  // MH-80 Ghost Hawk
    ["B_CTRG_Heli_Transport_01_DAP_F",350,400,150],                     // MH-80 DAP Ghost Hawk (Stub Wings)
...
*/
KPLIB_b_vehToUnlock = [
    ["B_Boat_Armed_01_minigun_F",""],                                   // Mk.V SOCOM
    ["B_MBT_01_arty_F",""],                                             // M4 Scorcher
    ["B_Heli_Attack_01_dynamicLoadout_F", ""],                          // RAH-66 Comanche
    ["B_Heli_Attack_01_pylons_dynamicLoadout_F", ""],                   // RAH-66 Comanche (Stub Wings)
    ...
    ["B_Heli_Transport_01_pylons_F", ""],                               // UH-80 Ghost Hawk (Stub Wings)
    ["B_CTRG_Heli_Transport_01_DAP_F", ""]                              // MH-80 DAP Ghost Hawk
];