...
force AAA_VAR_PLAYER_ARMOR_COEF = 5;
...
force ace_common_deployedSwayFactor = 0.4;
...
force ace_common_restedSwayFactor = 0.55;
...
force ace_cookoff_cookoffEnableProjectiles = false;
force ace_cookoff_cookoffEnableSound = false;
...
force ace_medical_AIDamageThreshold = 1.2;
...
force ace_medical_dropWeaponUnconsciousChance = 1;
...
force ace_medical_painUnconsciousChance = 0;
...
force ace_medical_treatment_treatmentTimeAutoinjector = 8;
...
force ace_medical_treatment_treatmentTimeIV = 15;
...
force ace_medical_treatment_treatmentTimeTrainedSplint = 4;
...
force ace_nightvision_fogScaling = 0.441918;
force ace_nightvision_noiseScaling = 0.427571;
ace_nightvision_shutterEffects = false;

// ACE Overheating
force ace_overheating_cookoffCoef = 0;
force ace_overheating_coolingCoef = 0.4;
...
force ace_overheating_suppressorCoef = 1.1;
...
force ace_repair_repairDamageThreshold_engineer = 0.0990013;
...
force RECOIL_accumulative_on = 1.1;
...
force RECOIL_AI_deviation = 0.05;
force RECOIL_AI_deviationDistance = 0.1;
force RECOIL_AI_deviationVisibility = 0.25;
...
force RECOIL_force_on = 100;
force RECOIL_handgun_on = true;
force RECOIL_incrase_on = 1.1;
force RECOIL_limit_on = 2.6;
force RECOIL_negative_on = 0;
...
force RECOIL_varietyC_on = 2.4;
force RECOIL_varietyCk_on = 1.1;
...
// LAMBS Danger
force lambs_danger_cqbRange = 59.9162;
...
// Pinned Down
force Mikeys_AISkill_cap = 0.35;
force Mikeys_AISup_burstSec = 1.5;
force Mikeys_AISup_capSec = 12;
force Mikeys_AISup_distance = 20;
force Mikeys_AISup_halflife = 5;
force Mikeys_AISup_strength = 1;
force Mikeys_AISupEnable = true;
force Mikeys_AIUseSuppressiveFire = true;
Mikeys_PLAYER_SUP_ENABLED = true;
force MKY_BRAIN_HYBRID = true;
force PD_AIM_DMG_MULT = 3;
force PD_AIM_EASE = 0.07;
force PD_AIM_MAX = 12;
force PD_AIM_SUP_MULT = 2.65;
force PD_BLINK_COOLDOWN = 2.2;
PD_BLINK_ENABLE = false;
force PD_CAMSHAKE_ENABLE = true;
force PD_CAMSHAKE_MULT = 0.8;
force PD_DECAY_HALFLIFE = 1.1;
force PD_EVENT_LATCH = 0.25;
force PD_MIN_IMPULSE_UP = 0.04;
force PD_RECOIL_STRESS_MULT = 0.91;
force PD_RED_CAP = 0.14635;
force PD_SUP_FLOOR = 0.08;
force PD_TICK = 0.5;
force PD_TUNNEL_CAP = 0.7;
force PD_TUNNEL_CD = 0.35;
force PD_TUNNEL_FADE = 1.15;
force PD_TUNNEL_ONSET = 0.05;
force PD_VISUAL_MODE = 1;
...
tsp_cba_animate_sling_sprint = true;
